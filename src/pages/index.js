...
export default function Home() {
    ...
    return (
        <>
            ...
            <Head>
                <title>Shigrie | PortFolio</title>
                <meta
                    name="description"
                    content="Shigrie | PortFolio"
                />
                <meta property="og:title" content="Shigrie | PortFolio" />
                <meta
                                ...
                                >
                                    ...
                                    <span
                                        className={`h-[2px] inline-block bg-dark dark:bg-light absolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 ${
                                            router.asPath === "mailto:bakhtawaralishigri@gmail.com"
                                                ? "w-full"
                                                : "w-0"
                                        }`}
                                    ></span>
